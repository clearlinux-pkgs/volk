...
Source0  : https://www.libvolk.org/releases/volk-3.2.0.tar.gz
Source1  : https://www.libvolk.org/releases/volk-3.2.0.tar.gz.asc
...
%setup -q -n volk-3.2.0
cd %{_builddir}/volk-3.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744065152
mkdir -p clr-build
pushd clr-build
...
mv %{buildroot}/usr/lib64/cmake/volk/* %{buildroot}/usr/lib64/cmake/
## install_append end
...
/usr/include/volk/volk_32f_reciprocal_32f.h
...
/usr/lib64/cmake/VolkConfig.cmake
/usr/lib64/cmake/VolkConfigVersion.cmake
/usr/lib64/cmake/VolkTargets-relwithdebinfo.cmake
/usr/lib64/cmake/VolkTargets.cmake
/usr/lib64/libvolk.so
/usr/lib64/pkgconfig/volk.pc

%files lib
%defattr(-,root,root,-)
/usr/lib64/libvolk.so.3.2
